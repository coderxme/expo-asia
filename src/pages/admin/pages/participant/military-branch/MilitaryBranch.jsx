...
const MilitaryBranch = () => {
  const { militaryBranchData, fetchMilitaryBranch, deleteMilitaryBranch, updateMilitaryBranch, setCsrfToken, createMilitaryBranch } = useAdminStore();
  ...
  }, [fetchMilitaryBranch, setCsrfToken, csrfToken]);
