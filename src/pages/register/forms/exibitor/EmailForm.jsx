...
import { apiEmailConfirmation,  apiRegisterCompanyNoCaptcha, apiQRCode} from '../../../../api/api';
...
export default function EmailForm({ email, csrfToken, hashedCode, formDataReg }) {
  ...
  const handleCompanySubmit = async () => {
    setIsVerifying(true);
    try {
      const response = await axios.post(apiRegisterCompanyNoCaptcha, formInviteData, {
        headers: {
          'X-CSRFToken': csrfToken
        }
      });
